...
@section('admin_content')
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <a class="breadcrumb-item" href="{{ url('admin/create/employee') }}">Create Employee</a>
                    ...
                    {{-- <form action=" " method="post" enctype="multipart/form-data"> --}}
                        ...
                        <div class="form-layout">
                            <div class="row mg-b-25">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label"><span style="color: red">*</span> Employee Name: </label>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label"><span style="color: red">*</span> Designation: </label>
                            ...
                            <div class="form-layout-footer" style="float: right">
                                <button class="btn btn-success mg-r-5">Add Employee</button>
