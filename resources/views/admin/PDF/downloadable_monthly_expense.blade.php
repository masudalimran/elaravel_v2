...
<body>
    ...
    <div style="line-height: 10%;">
        ...
        <h1 style="text-align: center; line-height: 10%;"> <b style="color: blue; font-size: 20px;"> BISMIB TECHNOLOGY </b> </h1>

        <h3 style="text-align: center; text-decoration: underline; line-height: 10%;"> <b style="font-size: 16px;"> Expense Sheet</b></h3>
        @if ($pdf_data[2] == 0)
