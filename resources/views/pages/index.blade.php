								...
								<div class="featured_slider slider">
									...
									<div class="featured_slider_item">
										...
										<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
											<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{URL::to($row->image_2)}}" style="height: 130px; width: 150px"></div>
											<div class="product_content">
  												@if($row->discount_price == NULL)
													<div class="product_price discount">৳ {{$row->selling_price}}</div>
												@else
													<div class="product_price discount">৳ {{$row->selling_price - $row->discount_price}}<span class="text-info"><del>৳ {{$row->selling_price}}</del></span></div>
												@endif
											...
											<ul class="product_marks">
												@if($row->discount_price == NULL)
												@else
													<li class="product_mark product_discount" >-{{round(($row->discount_price/$row->selling_price)*100)}}%</li>
												@endif
												@if($row->hot_new == NULL)
												@else
													<li class="product_mark product_discount" style="background: #10b529;" >New</li>
												@endif
