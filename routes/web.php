...
// Route::group(['prefix' => 'admin'], function () {
    ...
    Route::get('admin/download/expense/pdf/{month_name}/{month}','Admin\Expense_sheet\ExpenseController@download_expense_pdf')->name('download.expense.pdf');
        ...
        //Attendance Sheet
    Route::get('admin/create/employee','Admin\Attendance\AttendanceController@create_employee');
    Route::post('admin/store/employee','Admin\Attendance\AttendanceController@store_employee')->name('store.employee');
    Route::get('admin/give_attendance','Admin\Attendance\AttendanceController@give_attendance');
    Route::post('admin/store/attendance','Admin\Attendance\AttendanceController@store_attendance')->name('store.attendance');
    Route::get('admin/show_attendance','Admin\Attendance\AttendanceController@show_attendance');
    Route::get('admin/delete/employee/{id}','Admin\Attendance\AttendanceController@delete_employee');
    // Route::get('admin/view/expense','Admin\Expense_sheet\AttendanceController@view_expense_sheet');
    // Route::post('admin/store/expense_sheet','Admin\Expense_sheet\AttendanceController@store_expense_sheet')->name('store.expense_sheet');
    // Route::get('admin/view/expense','Admin\Expense_sheet\AttendanceController@view_expense');
    // Route::get('admin/view/expense/by/year','Admin\Expense_sheet\AttendanceController@select_expense_year');
    // Route::get('admin/view/expense/by/month/{year}','Admin\Expense_sheet\AttendanceController@view_expense_by_month');
